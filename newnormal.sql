...
--
-- Host: localhost
-- Generation Time: Oct 22, 2021 at 05:39 PM
...
--
-- Table structure for table `tb_billdrug`
--

CREATE TABLE `tb_billdrug` (
  `bill_id` int(10) NOT NULL COMMENT 'เลขที่ใบสั่งยา',
  `bill_date` date NOT NULL COMMENT 'วัน/เดือน/ปีที่สั่งจ่าย',
  `bill_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'เวลาที่สั่งจ่าย',
  `bill_next` varchar(50) DEFAULT NULL COMMENT 'วันนัดครั้งต่อไป',
  `bill_status` varchar(20) DEFAULT NULL COMMENT 'สถานะการจ่ายยา',
  `drug_id` varchar(50) DEFAULT NULL COMMENT 'รหัสยา',
  `tm_id` int(11) NOT NULL COMMENT 'เลขที่การรักษา'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลการสั่งจ่ายยา';

--
-- Dumping data for table `tb_billdrug`
--

INSERT INTO `tb_billdrug` (`bill_id`, `bill_date`, `bill_time`, `bill_next`, `bill_status`, `drug_id`, `tm_id`) VALUES
(388, '2021-10-18', '2021-10-18 19:36:07', '', 'C', NULL, 98),
(389, '2021-10-18', '2021-10-18 14:26:00', '', 'C', NULL, 99),
(390, '2021-10-19', '2021-10-18 19:34:51', '', 'O', NULL, 100),
(391, '2021-10-19', '2021-10-18 19:59:48', '2021-10-21', 'O', NULL, 101),
(392, '2021-10-19', '2021-10-19 02:32:23', '2021-10-21', 'O', NULL, 102);

-- --------------------------------------------------------

--
-- Table structure for table `tb_billdrug_detail`
--

CREATE TABLE `tb_billdrug_detail` (
  `billdrug_detail_id` int(10) NOT NULL COMMENT 'รหัส',
  `bill_id` int(10) NOT NULL COMMENT 'เลขที่ใบสั่งยา',
  `drug_id` varchar(50) NOT NULL COMMENT 'รหัสยา',
  `drug_name` varchar(50) DEFAULT NULL COMMENT 'ชื่อยา',
  `drug_count` varchar(11) DEFAULT NULL COMMENT 'จำนวน',
  `drug_price` decimal(20,4) DEFAULT NULL COMMENT 'ราคาต่อหน่วย',
  `drug_total_price` decimal(20,4) DEFAULT NULL COMMENT 'จำนวนเงินรวม'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='รายละเอียดสั่งยา';

--
-- Dumping data for table `tb_billdrug_detail`
--

INSERT INTO `tb_billdrug_detail` (`billdrug_detail_id`, `bill_id`, `drug_id`, `drug_name`, `drug_count`, `drug_price`, `drug_total_price`) VALUES
(293, 388, '004', 'ABIRATERONE-TEVA', '1', '120.0000', '120.0000'),
(294, 388, '002', 'ABACAVIR-GPO', '1', '50.0000', '50.0000'),
(295, 389, '001', 'SERTRALINE', '3', '60.0000', '180.0000'),
(296, 389, '002', 'ABACAVIR-GPO', '1', '50.0000', '50.0000'),
(297, 390, '001', 'SERTRALINE', '1', '60.0000', '60.0000'),
(298, 390, '005', 'NYCIPFLOX-250', '3', '150.0000', '450.0000'),
(299, 391, '004', 'ABIRATERONE-TEVA', '2', '120.0000', '240.0000'),
(300, 391, '001', 'SERTRALINE', '3', '60.0000', '180.0000'),
(301, 392, '005', 'NYCIPFLOX-250', '2', '150.0000', '300.0000'),
(302, 392, '004', 'ABIRATERONE-TEVA', '2', '120.0000', '240.0000'),
(303, 392, '001', 'SERTRALINE', '3', '60.0000', '180.0000');
...
CREATE TABLE `tb_booking` (
  `bk_id` int(10) NOT NULL COMMENT 'รหัสการจองคิว',
  `bk_queue` varchar(3) DEFAULT NULL COMMENT 'หมายเลขคิว',
  `bk_date` varchar(50) NOT NULL COMMENT 'ว/ด/ป ที่จอง',
  `bk_time` varchar(50) NOT NULL COMMENT 'เวลา ที่จอง',
  `bk_symptom` varchar(50) DEFAULT NULL COMMENT 'อาการของโรค',
  `bk_status` varchar(20) DEFAULT NULL COMMENT 'สถานะคิว',
  `bk_department` varchar(100) DEFAULT NULL COMMENT 'แผนกการรักษา',
  `user_id` int(11) NOT NULL COMMENT 'รหัสผู้ใช้ระบบ',
  `mail_flag` varchar(100) DEFAULT NULL COMMENT 'สถานะแจ้งเตือน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลการจองคิว';

--
-- Dumping data for table `tb_booking`
--

INSERT INTO `tb_booking` (`bk_id`, `bk_queue`, `bk_date`, `bk_time`, `bk_symptom`, `bk_status`, `bk_department`, `user_id`, `mail_flag`) VALUES
(69, '1', '2021-10-15', '10:00', '-', 'C', 'ศัลยกรรมกระดูก', 54, 'N'),
(70, '1', '2021-10-15', '09:30', 'ปวดเมื่อยตามร่างกาย', 'C', 'ศัลยกรรมกระดูก', 54, 'N'),
(71, '2', '2021-10-19', '10:00', 'ไอ จาม', 'C', 'ศัลยกรรมกระดูก', 57, 'S'),
(72, '3', '2021-10-19', '10:30', 'ผื่น ไอ จาม', 'S', 'ศัลยกรรมกระดูก', 54, 'N'),
(73, '4', '2021-10-19', '11:00', '-', 'C', 'ศัลยกรรมกระดูก', 54, 'N'),
(77, '5', '2021-10-19', '08:45', 'ไอ จาม ผื่น', 'S', 'ศัลยกรรมกระดูก', 54, 'S'),
(78, '6', '2021-10-19', '10:00', 'ไอ จาม', 'W', 'ศัลยกรรมกระดูก', 54, 'S');
...
CREATE TABLE `tb_category` (
  `ctg_id` varchar(10) NOT NULL COMMENT 'รหัสหมวดหมู่ยา',
  `ctg_name` varchar(50) NOT NULL COMMENT 'ชื่อหมวดหมู่'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลหมวดหมู่ยา';

--
-- Dumping data for table `tb_category`
--

INSERT INTO `tb_category` (`ctg_id`, `ctg_name`) VALUES
('1', 'บัญชียาหลักแห่งชาติแผนปัจจุบัน'),
('2', 'บัญชียาจากสมุนไพร');
...
CREATE TABLE `tb_district` (
  `dis_id` int(11) NOT NULL COMMENT 'ไอดีอำเภอ',
  `dis_code` varchar(5) NOT NULL COMMENT 'รหัสอำเภอ',
  `dis_name_th` varchar(100) NOT NULL COMMENT 'ชื่ออำเภอ(ไทย)',
  `dis_name_eng` varchar(100) DEFAULT NULL COMMENT 'ชื่ออำเภอ(อังกฤษ)',
  `pvn_id` int(11) NOT NULL COMMENT 'ไอดีจังหวัด'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลอำเภอ';

--
-- Dumping data for table `tb_district`
--

INSERT INTO `tb_district` (`dis_id`, `dis_code`, `dis_name_th`, `dis_name_eng`, `pvn_id`) VALUES
...
CREATE TABLE `tb_drug` (
  `drug_id` varchar(10) NOT NULL COMMENT 'รหัสยา',
  `drug_name` varchar(50) NOT NULL COMMENT 'ชื่อยา',
  `drug_trademark` varchar(50) NOT NULL COMMENT 'ชื่อทางการค้า',
  `drug_active` varchar(50) NOT NULL COMMENT 'สถานะคงเหลือ',
  `drug_mfg` varchar(50) NOT NULL COMMENT 'วัน/เดือน/ปีที่ผลิต',
  `drug_exp` varchar(50) NOT NULL COMMENT 'วันหมดอายุ',
  `drug_amount` varchar(20) NOT NULL COMMENT 'จำนวนคงเหลือ',
  `drug_Price` decimal(14,4) NOT NULL COMMENT 'ราคาต่อหน่วย',
  `ctg_id` varchar(10) NOT NULL COMMENT 'รหัสหมวดหมู่'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลยา';

--
-- Dumping data for table `tb_drug`
--

INSERT INTO `tb_drug` (`drug_id`, `drug_name`, `drug_trademark`, `drug_active`, `drug_mfg`, `drug_exp`, `drug_amount`, `drug_Price`, `ctg_id`) VALUES
('001', 'SERTRALINE', 'สตาริน-50', 'เหลือ', '2021-04-01', '2023-04-01', '15', '60.0000', '1'),
('002', 'ABACAVIR-GPO', 'อะบาคาเวียร์-จีพีโอ', 'เหลือ', '2021-04-01', '2023-04-01', '35', '50.0000', '1'),
('003', 'VERZENIO', 'เวอซีนิโอ-100', 'เหลือ', '2021-04-01', '2023-04-01', '25', '70.0000', '1'),
('004', 'ABIRATERONE-TEVA', 'อะบิราเทอโรน-เทวา', 'เหลือ', '2021-04-01', '2023-04-01', '33', '120.0000', '1'),
('005', 'NYCIPFLOX-250', 'ไนซิปฟลอกซ์-250', 'เหลือ', '2021-04-01', '2023-04-01', '50', '150.0000', '1');
...
CREATE TABLE `tb_province` (
  `pvn_id` int(11) NOT NULL COMMENT 'ไอดีจังหวัด',
  `pvn_code` varchar(5) NOT NULL COMMENT 'รหัสจังหวัด',
  `pvn_name_th` varchar(100) NOT NULL COMMENT 'ชื่อจังหวัด(ไทย)',
  `pvn_name_eng` varchar(100) DEFAULT NULL COMMENT 'ชื่อจังหวัด(อังกฤษ)',
  `area` varchar(30) NOT NULL COMMENT 'ภูมิภาค'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลจังหวัด';

--
-- Dumping data for table `tb_province`
--

INSERT INTO `tb_province` (`pvn_id`, `pvn_code`, `pvn_name_th`, `pvn_name_eng`, `area`) VALUES
...
CREATE TABLE `tb_role` (
  `role_id` varchar(13) NOT NULL COMMENT 'รหัสประเภทผู้ใช้งาน',
  `role_name` varchar(50) NOT NULL COMMENT 'ชื่อผู้ใช้งาน',
  `role_description` varchar(100) DEFAULT NULL COMMENT 'คำอธิบาย',
  `role_status` varchar(50) NOT NULL COMMENT 'สถานะผู้ใช้งาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลสิทธิ์การเข้าใช้งาน';

--
-- Dumping data for table `tb_role`
--

INSERT INTO `tb_role` (`role_id`, `role_name`, `role_description`, `role_status`) VALUES
('1', 'ADMIN', 'ผู้ดูแลระบบ', 'A'),
('2', 'USER', 'ผู้ป่วย', 'A'),
('3', 'DOCTOR', 'แพทย์/เจ้าหน้าที่', 'A');
...
CREATE TABLE `tb_subdistrict` (
  `sdt_id` int(11) NOT NULL COMMENT 'รหัสตำบล',
  `zip_code` varchar(5) NOT NULL COMMENT 'รหัสไปรษณีย์',
  `sdt_name_th` varchar(100) NOT NULL COMMENT 'ชื่อตำบล(ไทย)',
  `sdt_name_eng` varchar(100) DEFAULT NULL COMMENT 'ชื่อตำบล(อังกฤษ)',
  `dis_id` int(11) NOT NULL COMMENT 'ไอดีอำเภอ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลตำบล';

--
-- Dumping data for table `tb_subdistrict`
--

INSERT INTO `tb_subdistrict` (`sdt_id`, `zip_code`, `sdt_name_th`, `sdt_name_eng`, `dis_id`) VALUES
...
CREATE TABLE `tb_treatment` (
  `tm_id` int(11) NOT NULL COMMENT 'เลขที่การรักษา',
  `tm_date` date DEFAULT NULL COMMENT 'ว/ด/ป ที่เข้ารักษา',
  `tm_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'เวลาที่เข้ารักษา',
  `tm_money` decimal(10,4) DEFAULT NULL COMMENT 'รวมจำนวนเงิน',
  `tm_slip` varchar(100) DEFAULT NULL COMMENT 'รูปสลิปจ่ายเงิน',
  `tm_status` varchar(50) DEFAULT NULL COMMENT 'สถานะการจ่ายเงิน',
  `tm_process` varchar(100) NOT NULL COMMENT 'แนวทางการรักษา',
  `user_id` int(11) DEFAULT NULL COMMENT 'รหัสผู้ใช้ระบบ',
  `bk_id` int(10) DEFAULT NULL COMMENT 'รหัสการจองคิว',
  `bill_id` int(10) NOT NULL COMMENT 'เลขที่สั่งจ่ายยา'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลการรักษาผู้ป่วย';

--
-- Dumping data for table `tb_treatment`
--

INSERT INTO `tb_treatment` (`tm_id`, `tm_date`, `tm_time`, `tm_money`, `tm_slip`, `tm_status`, `tm_process`, `user_id`, `bk_id`, `bill_id`) VALUES
(98, '2021-10-18', '2021-10-18 19:32:59', '170.0000', '', 'C', 'สั่งยา เฝ้าระวัง', 54, 69, 388),
(99, '2021-10-18', '2021-10-18 19:33:07', '230.0000', '', 'C', 'ดูอาการ', 54, 70, 389),
(100, '2021-10-19', '2021-10-18 19:35:02', '510.0000', '', 'N', 'พักผ่อน', 54, 69, 390),
(101, '2021-10-19', '2021-10-19 01:40:42', '420.0000', '', 'W', 'พักผ่อนให้เพียงพอ งดน้ำแข็ง', 54, 72, 391),
(102, '2021-10-19', '2021-10-19 02:31:24', '720.0000', 'C:\\fakepath\\IMG_1544.JPG', 'S', 'สั่งยา พักผ่อนให้เพียงพอ', 54, 77, 392);
...
CREATE TABLE `tb_user` (
  `user_id` int(11) NOT NULL COMMENT 'รหัสผู้ใช้ระบบ',
  `role_id` varchar(13) NOT NULL COMMENT 'รหัสประเภทผู้ใช้งาน',
  `user_username` varchar(100) NOT NULL COMMENT 'ชื่อผู้ใช้',
  `user_password` varchar(100) NOT NULL COMMENT 'รหัสผ่านผู้ใช้งาน',
  `user_card_id` varchar(13) NOT NULL COMMENT 'เลขบัตรประชาชน',
  `user_hn_id` varchar(10) DEFAULT NULL COMMENT 'รหัสผู้ป่วย',
  `user_title` varchar(20) NOT NULL COMMENT 'คำนำหน้า',
  `user_firstname` varchar(50) NOT NULL COMMENT 'ชื่อ',
  `user_lastname` varchar(50) NOT NULL COMMENT 'นามสกุล',
  `user_gender` varchar(10) NOT NULL COMMENT 'เพศ',
  `user_birthday` varchar(50) NOT NULL COMMENT 'วัน/เดือน/ปีเกิด',
  `user_blood` varchar(3) DEFAULT NULL COMMENT 'กรุ๊ปเลือด',
  `user_disease` varchar(40) DEFAULT NULL COMMENT 'โรคประจำตัว',
  `user_allergy` varchar(100) DEFAULT NULL COMMENT 'ประวัติการแพ้ยา',
  `user_department` varchar(100) DEFAULT NULL COMMENT 'แผนกการรักษา',
  `user_graduate` varchar(50) DEFAULT NULL COMMENT 'วุฒิการศึกษา',
  `user_profession_id` varchar(13) DEFAULT NULL COMMENT 'เลขที่ใบประกอบวิชาชีพ',
  `user_profession` varchar(100) DEFAULT NULL COMMENT 'ใบประกอบวิชาชีพ',
  `user_position` varchar(50) DEFAULT NULL COMMENT 'ตำแหน่ง',
  `user_phone` varchar(10) DEFAULT NULL COMMENT 'เบอร์โทรศัพท์',
  `user_email` varchar(100) NOT NULL COMMENT 'อีเมล',
  `user_status` varchar(10) NOT NULL COMMENT 'สถานะการใช้งาน',
  `user_addrass` varchar(100) DEFAULT NULL COMMENT 'ที่อยู่',
  `zip_code` varchar(5) NOT NULL COMMENT 'รหัสไปรษณีย์',
  `sdt_id` int(11) NOT NULL COMMENT 'รหัสตำบล'
...
INSERT INTO `tb_user` (`user_id`, `role_id`, `user_username`, `user_password`, `user_card_id`, `user_hn_id`, `user_title`, `user_firstname`, `user_lastname`, `user_gender`, `user_birthday`, `user_blood`, `user_disease`, `user_allergy`, `user_department`, `user_graduate`, `user_profession_id`, `user_profession`, `user_position`, `user_phone`, `user_email`, `user_status`, `user_addrass`, `zip_code`, `sdt_id`) VALUES
(1, '1', 'admin86', 'PturRi3Fuu1Y3bzofjxZJ7TJgI2FqoNh', '1139600088695', NULL, 'นาย', 'admin', 'admin', 'ชาย', '2000-03-28', 'A', NULL, NULL, NULL, 'บัณฑิต(ปริญญาตรี)', NULL, NULL, 'นักวิชาการคอมพิวเตอร์ปฏิบัติการ', '0984801539', 'narawutmax@gmail.com', 'A', '116/22', '44130', 440606),
(51, '3', 'doctor86', 'puyfeXrZ+XKaAv8bk57bqwRJwmuKdLCn', '3440600754649', NULL, 'นาย', 'วุฒิไกร', 'จันทรมาณิจ', 'ชาย', '1970-06-17', 'AB', NULL, NULL, 'ศัลยกรรมกระดูก', 'ดุษฎีบัณฑิต(ปริญญาเอก)', '613170010121', 'assets/images/mdcard.jpg', 'แพทย์ผู้เชี่ยวชาญด้านจักษุวิทยา', '0966961800', 'narawutmax@gmail.com', 'A', '116/22', '44120', 440907),
(54, '2', 'max123', 'iTE1GaHjzdxEefb4rokdoBIUexIQsxDb', '1139600089455', '640021', 'นาย', 'นราวุฒิ', 'วิแสง', 'ชาย', '2000-03-28', 'O', 'โรคกระดูก', 'แพ้อาหาร แพ้ยารุนแรง', 'ศัลยกรรมกระดูก', NULL, NULL, NULL, NULL, '0619911653', 'narawutmax@gmail.com', 'A', '116/2', '44130', 440606),
(55, '3', 'doctor99', 'waDsrl5mhIpek6lIzJG5Fr9ewl3o3W6b', '3440600754649', '', 'น.ส.', 'วนิดา', 'เมธากุล', 'หญิง', '1975-07-20', 'O', NULL, NULL, 'ศัลยกรรมกระดูก', 'ดุษฎีบัณฑิต(ปริญญาเอก)', '613170010208', NULL, 'แพทย์ผู้เชี่ยวชาญด้านรังสีวิทยา', '0658758695', 'narawutmax@gmail.com', 'A', '116/32', '46000', 461701),
(56, '1', 'admin99', 'Y+V/0bbT9AxYI2KU9Ai/ta+J1v1HLjlo', '1139600087456', '', 'นาย', 'เมธา', 'จันศรี', 'ชาย', '1996-06-20', 'A', NULL, NULL, NULL, '', '', NULL, '', '0942806538', 'narawutmax@gmail.com', 'A', '208/1', '43000', 430101),
(57, '2', 'user99', 'wZK6eSdlPogJi1KNZrsYa5FAfM8w3rRP', '1139600089000', '63210', 'น.ส.', 'วริยา', 'คำนิมิตร', 'ชาย', '2002-03-28', 'B', 'โรคกระดูก', 'แพ้รุนแรง', 'ศัลยกรรมกระดูก', NULL, NULL, NULL, NULL, '0981702219', 'narawutmax@gmail.com', 'A', '441/2', '44000', 440102);
...
--
-- Indexes for table `tb_billdrug`
--
ALTER TABLE `tb_billdrug`
  ADD PRIMARY KEY (`bill_id`);

--
-- Indexes for table `tb_billdrug_detail`
--
ALTER TABLE `tb_billdrug_detail`
  ADD PRIMARY KEY (`billdrug_detail_id`),
  ADD KEY `FKk05sr29kxfnc1md7134ytigwm` (`bill_id`);
...
--
-- Indexes for table `tb_subdistrict`
--
...
--
-- AUTO_INCREMENT for table `tb_billdrug`
--
ALTER TABLE `tb_billdrug`
  MODIFY `bill_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'เลขที่ใบสั่งยา', AUTO_INCREMENT=393;
--
-- AUTO_INCREMENT for table `tb_billdrug_detail`
--
ALTER TABLE `tb_billdrug_detail`
  MODIFY `billdrug_detail_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=304;
--
-- AUTO_INCREMENT for table `tb_booking`
--
ALTER TABLE `tb_booking`
  MODIFY `bk_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการจองคิว', AUTO_INCREMENT=79;
--
-- AUTO_INCREMENT for table `tb_treatment`
--
ALTER TABLE `tb_treatment`
  MODIFY `tm_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'เลขที่การรักษา', AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT for table `tb_user`
--
ALTER TABLE `tb_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้ใช้ระบบ', AUTO_INCREMENT=60;
--
-- Constraints for dumped tables
--

--
-- Constraints for table `tb_billdrug_detail`
--
ALTER TABLE `tb_billdrug_detail`
  ADD CONSTRAINT `FKk05sr29kxfnc1md7134ytigwm` FOREIGN KEY (`bill_id`) REFERENCES `tb_billdrug` (`bill_id`);
